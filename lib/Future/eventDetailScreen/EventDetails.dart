  ...
  Future<void> _getLocation() async {
    try {
      ...
      if (placemarks.isNotEmpty) {
        setState(() {
          location = placemarks[0].locality ?? 'Unknown';
        });
      }
    } catch (e) {
      setState(() {
      ...
      builder: (context, state) => Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            InkWell(
              onTap: () {
                EventDetailsScreenViewModel.get(context).deleteEvent(args, context);
                ...
                Container(
                  ...
                  child: SizedBox(
                    ...
                    child: GoogleMap(
                      ...
                      circles: {
                        Circle(
                          circleId: CircleId('eventLocation'),
                          center: LatLng(args.latitude ?? 5000, args.longitude ?? 5000),
